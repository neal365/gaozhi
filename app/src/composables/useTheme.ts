...
const themes: ThemeConfig[] = [
 { name: '米黄稿纸', value: 'rice-paper', bgColor: '#F5F0E6', textColor: '#2C2C2C', lineColor: '#C4B49A', description: '温暖的米黄色稿纸' },
 { name: '仿古宣纸', value: 'antique-paper', bgColor: '#E8DFC4', textColor: '#3D3229', lineColor: '#B9A87D', description: '古朴典雅的宣纸质感' },
 { name: '纯白纸张', value: 'white-paper', bgColor: '#FFFFFF', textColor: '#1A1A1A', lineColor: '#CCCCCC', description: '干净简洁的白纸' },
];
